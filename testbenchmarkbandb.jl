...
const functions = get_functions("Branch and Bound - 1|r_j|Lmax", "Branch and Bound - Carlier")

instances_with_functions = mix_instances_with_functions(instances, functions)

make_tests(instances_with_functions, timeout, "results/resultsFromBenchmarks/resultbandb.csv")
